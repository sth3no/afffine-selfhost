  ...
  server.registerTool(
    "add_database_row",
    {
      ...
      inputSchema: {
        ...
        cells: z.record(z.string(), z.unknown()).describe("Map of column name (or column ID) to cell value. For select columns, pass the display label (option auto-created if new)."),
  ...
  server.registerTool(
    "update_database_row",
    {
      ...
      inputSchema: {
        ...
        cells: z.record(z.string(), z.unknown()).describe("Map of column name (or column ID) to new cell value. Use `title` for the built-in row title."),
  ...
  server.registerTool(
    "compose_database_from_intent",
    {
      ...
      inputSchema: {
        ...
        seedRows: z.array(z.record(z.string(), z.unknown())).optional().describe("Optional starter rows. If omitted, the preset starter rows are used."),
        placement: z.object({
          parentId: z.string().optional(),
          afterBlockId: z.string().optional(),
          beforeBlockId: z.string().optional(),
